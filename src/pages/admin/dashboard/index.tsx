	...
	return (
		<AdminLayout>
			<main className="w-full flex-grow p-6 min-h-screen">
				<h1 className="text-3xl text-teal-400 pb-6">Dashboard</h1>

				<div className="grid grid-cols-4">
					<div className="w-full bg-teal-400 shadow-lg rounded-2xl h-fit  p-5">
						<h1 className="font-semibold text-xl text-white">Total Pasien</h1>
						<div className="flex items-center justify-between">
							<h1 className="text-6xl text-white">{pasien?.totalData}</h1>
							<LuBaby className="w-20 h-20 text-white" />
						</div>
					</div>
				</div>
